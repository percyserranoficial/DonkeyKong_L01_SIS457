...
void ADonkeyKong_L01GameMode::BeginPlay()
{
		...
		EnemigoSpawnLocation.SetLocation(FVector(1160.0f, -110.0f, 840.0f));  // Cambia la ubicación según lo necesites
		...
		PlataformaSpawnLocation.SetLocation(FVector(1160.0f, 0.0f, 1100.0f));  // Cambia la ubicación según lo necesites
