...
{
	//float randomSpeed = FMath::RandRange(0.0f, 1000.0f);
	...
	float MaxSpeed = 2000.0f; //velocidad maxima
	...
	GEngine->AddOnScreenDebugMessage(-1, 50.f, FColor::Cyan, FString::Printf(TEXT("La velocidad es: %f"), RandomSpeed));// ESTA LINEA DE CODIGO MUESTRA POR UN MOMENTO LA VELOCIDAD A LA QUE SE MOVERA EL PERSONA
}